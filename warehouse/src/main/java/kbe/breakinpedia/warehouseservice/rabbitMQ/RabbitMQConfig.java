...
public class RabbitMQConfig {
    ...
    @Bean
    public Binding warehouseRequestBinding(Queue warehouseRequestQueue, TopicExchange warehouseExchange) {
        return BindingBuilder.bind(warehouseRequestQueue).to(warehouseExchange).with("WarehouseRoutingKey");
    }
}
