package kbe.breakinpedia.orderservice.configuration;
...
public class RabbitMQConfig {
    ...
    public Queue warehouseResponseQueue() {
        return new Queue("warehouse-request-queue");
    }
    ...
    public Binding warehouseResponseBinding() {
        return BindingBuilder.bind(paymentResponseQueue()).to(paymentExchange()).with("WarehouseRoutingKey");
    }
}
